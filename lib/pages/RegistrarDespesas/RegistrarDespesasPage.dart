...
class RegistrarDespesasPage extends StatefulWidget {
  const RegistrarDespesasPage({super.key});

  @override
  State<RegistrarDespesasPage> createState() => _RegistrarDespesasPageState();
}

class _RegistrarDespesasPageState extends State<RegistrarDespesasPage> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Column(
              children: [
                Text("DESPESA",style: TextStyle(color: Colors.white,fontSize: 30)),
                SizedBox(height: 80,),
                Column(
                  children: [
                    Column(
                      ...
                      children: [
                        Text("Insira a Quantia da Despesa:",style: TextStyle(color: Colors.white,fontSize: 20)),
                        TextField(
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Selecione a Categoria da Despesa:",style: TextStyle(color: Colors.white,fontSize: 20)),
                          ...
                          child: DropdownButton2(
                            ...
                            dropdownStyleData: DropdownStyleData(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: const Color.fromARGB(255, 124, 0, 0),
                              ),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Data da retirada:",style: TextStyle(color: Colors.white,fontSize: 20)),
                        TextField(
                    ...
                    TextButton(
                      onPressed: () {
                        if(quantiaController.text!="" && selectedCategoria!="" && dataController.text!=""){
                          ...
                          usuarioContext.removerSaldo(double.parse(quantiaController.text));
